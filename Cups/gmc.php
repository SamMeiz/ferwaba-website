...
<meta name="description" content="Genocide Memorial Cup - Rwanda's premier basketball tournament honoring memory and celebrating excellence.">
...
<section class="tournament-header">
  <div class="container">
    ...
    <p class="tournament-subtitle">Rwanda's Premier Basketball Tournament Honoring Memory and Celebrating Excellence</p>
  ...
  <div class="highlights-grid">
    <div class="highlight-card">
      ...
      <div class="highlight-content">
        ...
        <p>Experience the grand opening of the 2025 Genocide Memorial Cup with spectacular performances and tributes.</p>
      </div>
    </div>
...
<section class="cta-section">
  <div class="container">
    ...
    <p class="cta-subtitle">Get your tickets now for the remaining games and be part of Rwanda's biggest basketball event of the year.</p>
    <div>
  ...
  <div class="footer-container">
    <div class="footer-top">
      <div class="footer-brand">
        ...
        <p style="max-width: 300px;">Genocide Memorial Cup - Honoring memory through the spirit of basketball excellence.</p>
      </div>
