            ...
            <div class="hero-right">
                <div class="hero-content-wrapper">
                    <div class="hero-content active" data-slide="1">
                        ...
                        <a href="competitions" class="btn btn-primary">Check out Competitions</a>
                    </div>
                    ...
                    <div class="hero-content" data-slide="2">
                        ...
                        <a href="../competitions/rbl/pages/index" class="btn btn-primary">View RBL</a>
                    </div>
    ...
    <section class="featured-artworks">
        <div class="container">
                ...
                <div class="artwork-card">
                    <div class="artwork-image">
                        ...
                        <div class="artwork-overlay">
                            <a href="../competitions/supercup" class="btn btn-outline">View SuperCup</a>
                        </div>
                    </div>
                    <div class="artwork-info">
                        <a href="../competitions/supercup" style="text-decoration: none; color: inherit;">
                            <h3>Ferwaba SuperCup</h3>
                        </a>
                    </div>
                </div>
                <div class="artwork-card">
                    <div class="artwork-image">
                        ...
                        <div class="artwork-overlay">
                            <a href="../competitions/gmc" class="btn btn-outline">View GMC</a>
                        </div>
                    </div>
                    <div class="artwork-info">
                        <a href="../competitions/gmc" style="text-decoration: none; color: inherit;">
                            <h3>Genocide Memorial Cup(GMC)</h3>
                        </a>
                    </div>
                </div>
                <div class="artwork-card">
                    <div class="artwork-image">
                        ...
                        <div class="artwork-overlay">
                            <a href="../competitions/rwanda-cup" class="btn btn-outline">View Details</a>
                        </div>
                    </div>
                    <div class="artwork-info">
                        <a href="../competitions/rwanda-cup" style="text-decoration: none; color: inherit;">
                            <h3>Rwanda Cup</h3">
                        </a>
                    </div>
                </div>
            ...
            <div class="text-center">
                <a href="competitions" class="btn btn-secondary">View All Competitions</a>
            </div>
        </div>
    </section>
            ...
            <div class="events-grid">
                <div class="event-card">
                    ...
                    <div class="event-content">
                        ...
                        <p class="event-description">The championship series begins with top teams battling for the
                            title.</p>
                    </div>
                </div>
                <div class="event-card">
                    ...
                    <div class="event-content">
                        ...
                        <p class="event-description">Professional players mentor young athletes in skills development.
                        </p>
                    </div>
                </div>
                <div class="event-card">
                    ...
                    <div class="event-content">
                        ...
                        <p class="event-description">The best players showcase their talents in this annual celebration.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="news-grid">
                <div class="news-card">
                    ...
                    <div class="news-details">
                        ...
                        <p>The Rwanda Basketball Federation (FERWABA) has appointed François-Régis Gahuranyi as its new
                            Executive Director.
                            Gahuranyi, who previously served as Executive Director of the Rwanda Cycling Federation
                            (FERWACY), replaces Fionah Ishimwe, who held the position for the past three years.</p>
                ...
                <div class="news-card">
                    ...
                    <div class="news-details">
                        ...
                        <p>The 2027 FIBA World Cup qualifiers will be played across six windows between November 2025
                            and March 2027, with a total of 420 games worldwide. The African windows are scheduled for
                            November 2025, February 2026, and July 2026.</p>
                        <a href="#" class="news-link">Read More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="news-card">
                    ...
                    <div class="news-details">
                        ...
                        <p>APR secured their first Women's Basketball League Africa (WBLA) Zone 5 title, defeating
                            rivals Rwanda Energy Group (REG) 82-71 in an entertaining final on in Nairobi, Kenya, on
                            Saturday.</p>
                        <a href="#" class="news-link">Read More <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="social-links"
                    style="display: flex; justify-content: center; gap: 30px; margin: 40px 0; font-size: 3em;">
                    <a href="https://www.instagram.com/ferwaba" target="_blank" class="social-link"
                        style="color: #E1306C; transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://www.youtube.com/@ferwaba" target="_blank" class="social-link"
                        style="color: #FF0000; transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
                        <i class="fab fa-youtube"></i>
                    </a>
                    <a href="https://www.facebook.com/ferwaba" target="_blank" class="social-link"
                        style="color: #1877F2; transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
                        <i class="fab fa-facebook"></i>
                    </a>
                    <a href="https://www.twitter.com/ferwaba" target="_blank" class="social-link"
                        style="color: #1DA1F2; transition: transform 0.3s;"
                        onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
