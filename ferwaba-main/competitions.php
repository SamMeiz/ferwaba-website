...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .league-info { padding: 35px; text-align: center; }
    .league-info h3 { margin: 0 0 15px; color: #212529; font-size: 2rem; font-family: 'Playfair Display', serif; }
    .league-info p { color: #6c757d; margin: 0 0 25px; font-size: 1.05rem; line-height: 1.7; }
    .league-stats { 
        display: flex; 
    ...
    .stat-label { font-size: 0.85rem; color: #6c757d; text-transform: uppercase; letter-spacing: 1px; margin-top: 5px; }
    ...
    .cup-info { padding: 28px; text-align: center; }
    .cup-info h3 { margin: 0 0 12px; color: #212529; font-size: 1.5rem; font-family: 'Playfair Display', serif; }
    .cup-info p { color: #6c757d; margin: 0 0 20px; font-size: 0.95rem; line-height: 1.6; }
    .cup-stats { 
        display: flex; 
        justify-content: space-around; 
        margin-top: 20px; 
    ...
    .cup-stats .stat-value { font-size: 1.5rem; }
    .cup-stats .stat-label { font-size: 0.8rem; }
   ...
   <nav class="navbar">
    ...
    <main class="site-main">
        ...
        <section class="section" style="padding-top: 120px;">
            ...
            .league-container .league-logo { height: 180px !important; }
            </style>
            <div class="league-container">
                <div class="league-card">
                    <div class="league-logo">
                        <img src="assets/images/Rbl.jpg" alt="Rwanda Basketball League" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
            ...
            <div class="cups-grid">
                ...
                <div class="cup-card">
                    <div class="cup-logo" style="background: linear-gradient(135deg, #DC143C 0%, #8B0000 100%);">
                        <img src="assets/images/gmc.jpg" alt="Genocide Memorial Cup" style="width:100%; height:100%; object-fit:cover; display:block;">
                    </div>
                    <div class="cup-info">
                ...
                <div class="cup-card">
                      <div class="cup-logo" style="background: linear-gradient(135deg, #DC143C 0%, #8B0000 100%);">
                        <img src="assets/images/hero.jpg" alt="Genocide Memorial Cup" style="width:100%; height:100%; object-fit:cover; display:block;">
                    </div>
                    <div class="cup-info">
                        <h3>Heroes Cup</h3>
                ...
                <div class="cup-card">
                      <div class="cup-logo" style="background: linear-gradient(135deg, #DC143C 0%, #8B0000 100%);">
                        <img src="assets/images/RC.jpg" alt="Genocide Memorial Cup" style="width:100%; height:100%; object-fit:cover; display:block;">
                    </div>
                    <div class="cup-info">
                        <h3>Rwanda Cup</h3>
                ...
                <div class="cup-card">
                      <div class="cup-logo" style="background: linear-gradient(135deg, #DC143C 0%, #8B0000 100%);">
                        <img src="assets/images/SPC.jpg" alt="Genocide Memorial Cup" style="width:100%; height:100%; object-fit:cover; display:block;">
                    </div>
                    <div class="cup-info">
                        <h3>Super Cup</h3>
