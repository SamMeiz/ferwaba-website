...
<head>
    ...
    <title>Privacy Policy - Ferwaba</title>
    <meta name="description"
        content="FERWABA privacy policy describing how we collect, use, and protect personal information.">
    <meta name="keywords" content="FERWABA privacy policy, Rwanda Basketball Federation, data protection">
        ...
        <div class="container">
            <div class="story-content">
                <div class="story-text">
                    ...
                    <p>We collect information you provide when you contact FERWABA, register for events, or submit
                        forms. This may include your name, email address, phone number, and any details you choose to
                        share.</p>
                    <p>We also collect basic usage data such as pages visited and device information to improve our
                        services and maintain site security.</p>

                    <h2>How We Use Information</h2>
                    <p>We use information to respond to inquiries, manage competitions and programs, improve our
                        website, and communicate important updates.</p>

                    <h2>Cookies</h2>
                    <p>We use cookies and similar technologies to support site functionality and analytics. You can
                        adjust your browser settings to control cookie usage.</p>

                    <h2>Sharing and Security</h2>
                    <p>We do not sell personal information. We may share information with trusted service providers who
                        support FERWABA operations, and we protect data using reasonable administrative and technical
                        safeguards.</p>

                    <h2>Your Choices</h2>
                    <p>You may request access, updates, or deletion of your personal information by contacting us at
                        info@ferwaba.rw.</p>
                </div>
            </div>
        </div>
