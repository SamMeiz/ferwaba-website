...
$coaches = $db->query("SELECT c.id, c.name, c.role, c.nationality, c.photo, t.name AS team_name 
                      FROM coaches c LEFT JOIN teams t ON t.id=c.team_id 
                      ORDER BY t.name ASC, c.role ASC, c.name ASC")->fetchAll();
?>
...
<div class="admin-card">
  <div class="admin-card-header">
    ...
    <span style="color: var(--gray-500); font-size: 14px;"><?php echo count($coaches); ?> coaches</span>
  </div>
          ...
          <tr>
            ...
            <td>
              <div class="action-links">
                ...
                <a href="delete-coach.php?id=<?php echo (int) $c['id']; ?>" class="action-link delete"
                  onclick="return confirm('Delete coach?')">
